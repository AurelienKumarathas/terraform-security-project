...
![Pipeline Overview](screenshots/pipeline-overview%202.png)
...
![Pipeline Annotations](screenshots/pipeline-annotations%202.png)
...
| **Solution** | Automated IaC scanning integrated into CI/CD |
...
- **Secure Module Design** — Reusable hardened Terraform modules (S3, EC2, RDS) that make the secure path the default path
